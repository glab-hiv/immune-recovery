#-------------------------------------------------------------------------------
# Title: ACTG 5248 analysis of CD4 T cell Memory Restoration using MSI data
...
ACTG <- read.csv(file = paste0(curr_dir,'Data/msi_data/CD4+ MSI A5248_V2.csv'))
#Modify here as data is updated
DS <- read.csv(file = paste0(curr_dir,'Data/msi_data/CD4+ MSI LT-ART_V3.csv'))
...
pdf(file = paste0(curr_dir,"data/output/CD4_ACTG_MSI_residuals.pdf"))
...
pdf(file = paste0(curr_dir,"data/output/CD4_DS_MSI_residuals.pdf"))
...
require(writexl)
#Modify here as data is updated
write_xlsx(fems_ACTG, paste0(curr_dir,"data/output/MSI_CD4_ACTG_analysis_AMW_10participants_03May2023.xlsx"))
#Modify here as data is updated
write_xlsx(fems_DS, paste0(curr_dir,"data/output/MSI_CD4_DS_analysis_AMW_10participants_03May2023.xlsx"))