...
ACTG <- read.csv(file = paste0(curr_dir,'Data/updated_v2/ACTG CD8 subpopulations Event Counts_10 participants_v5_with FC.csv'))
DS <- read.csv(file = paste0(curr_dir,'Data/updated_v2/CD8 CHI Durably Suppressed Event Counts_v4.csv'))
...
#-------------------------------------
require(writexl)
write_xlsx(fems_ACTG, paste0(curr_dir,"data/output/CD8_ACTG_analysis_AMW_10participants_13Dec2022.xlsx"))
write_xlsx(fems_DS, paste0(curr_dir,"data/output/CD8_DS_analysis_AMW_10participants_13Dec2022.xlsx"))